...
permalink: /protection-of-health-information/
variant: tiptap
description: ""
---
<h4>Baseline cybersecurity and data security measures </h4>
...
<h4>NEHR has safeguards to protect against cyber-attacks </h4>
...
<h4>How we prevent improper access and use of your NEHR records</h4>
...
<h4>What happens when a cybersecurity incident, data breach or unauthorised access to NEHR occurs?</h4>
...
<h4>Entities can be required to take corrective action</h4>
...
<p>• Strict penalties will apply to any authorised persons’ unauthorised
access, collection or use of NEHR information. There will also be enhanced
penalties in place to serve as a deterrent in certain scenarios:</p>
...
the power to direct the System Operator to take a range of actions with
immediate effect to prevent or minimise harm to individuals arising from
the non-compliance/ breach. For example, the System Operator may limit
the data types that an user may access, suspend or remove an users’ access
to NEHR.</p>
<p>• Min(H) may tap on emergency powers and direct healthcare providers to
perform non-cyber mitigating measures to respond to threats and incidents
affecting health information</p>
<p></p>