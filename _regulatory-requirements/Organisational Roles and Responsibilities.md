...
<p>o Entities should ensure access to NEHR is only for patients under entities’
care.</p>
<p>o Entities should notify Synapxe of any personnel movements that affect
NEHR access to ensure NEHR accounts are removed in a timely fashion (e.g.,
personnel has left organisation or changed role).</p>
<p>o Entity should educate their personnel on appropriate use of NEHR information
...
<p>o Report cybersecurity incidents and data breaches within the specified
